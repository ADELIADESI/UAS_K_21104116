...
<form id="mhsUpdate">
  ...
  <div class="mb-3">
    <label for="asal" class="form-label">Asal Mahasiswa</label>
    <input type="text" class="form-control" id="txasal">
    <div id="asalHelp" class="form-text">Ubah Asal mahasiswa.</div>
  </div>
...
<script>
  ...
  function batal(){
      location.replace("http://localhost/UASWEBK/webproK/client/index.php?pg=mhs");
  }
</script>